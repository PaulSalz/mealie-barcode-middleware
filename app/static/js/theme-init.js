...
(function() {
    ...
    v12Bell.src = '/static/js/ui-v12-bell.js?v=2026.09.21.14';
    v12Bell.async = false;
    document.head.appendChild(v12Bell);

    if (window.location.pathname === '/settings') {
        var themePreview = document.createElement('script');
        themePreview.src = '/static/js/theme-live-v2.js?v=2026.09.21.14';
    ...
    if (window.location.pathname.startsWith('/barcodes/')) {
        ...
        targets.src = '/static/js/barcode-targets-v6.js?v=2026.09.21.14';
        targets.async = false;
