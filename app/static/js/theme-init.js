...
(function() {
    ...
    bell.src = '/static/js/ui-v12-bell.js?v=2026.09.21.21';
    bell.async = false;
    document.head.appendChild(bell);

    if (window.location.pathname === '/settings') {
        var themePreview = document.createElement('script');
        themePreview.src = '/static/js/theme-live-v2.js?v=2026.09.21.21';
    ...
    if (window.location.pathname.startsWith('/barcodes/')) {
        ...
        targets.src = '/static/js/barcode-targets-v6.js?v=2026.09.21.21';
        targets.async = false;
