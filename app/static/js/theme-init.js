...
(function() {
    ...
    legacyCss.href = '/static/css/ui-v2.css?v=2026.09.21.16';
    document.head.appendChild(legacyCss);

    var uiCss = document.createElement('link');
    uiCss.rel = 'stylesheet';
    uiCss.href = '/static/css/ui-v4.css?v=2026.09.21.16';
    document.head.appendChild(uiCss);

    var v6Css = document.createElement('link');
    v6Css.rel = 'stylesheet';
    v6Css.href = '/static/css/ui-v6.css?v=2026.09.21.16';
    document.head.appendChild(v6Css);

    var v9Css = document.createElement('link');
    v9Css.rel = 'stylesheet';
    v9Css.href = '/static/css/ui-v9.css?v=2026.09.21.16';
    document.head.appendChild(v9Css);

    var v12Css = document.createElement('link');
    v12Css.rel = 'stylesheet';
    v12Css.href = '/static/css/ui-v12.css?v=2026.09.21.16';
    document.head.appendChild(v12Css);

    var v13Css = document.createElement('link');
    v13Css.rel = 'stylesheet';
    v13Css.href = '/static/css/ui-v13.css?v=2026.09.21.16';
    document.head.appendChild(v13Css);

    var v14Css = document.createElement('link');
    v14Css.rel = 'stylesheet';
    v14Css.href = '/static/css/ui-v14.css?v=2026.09.21.16';
    document.head.appendChild(v14Css);

    var v16Css = document.createElement('link');
    v16Css.rel = 'stylesheet';
    v16Css.href = '/static/css/ui-v16.css?v=2026.09.21.16';
    document.head.appendChild(v16Css);

    var ui = document.createElement('script');
    ui.src = '/static/js/ui-v4.js?v=2026.09.21.16';
    ui.async = false;
    document.head.appendChild(ui);

    var v6 = document.createElement('script');
    v6.src = '/static/js/ui-v6.js?v=2026.09.21.16';
    v6.async = false;
    document.head.appendChild(v6);

    var v9 = document.createElement('script');
    v9.src = '/static/js/ui-v9.js?v=2026.09.21.16';
    v9.async = false;
    ...
    v12Bell.src = '/static/js/ui-v12-bell.js?v=2026.09.21.16';
    v12Bell.async = false;
    document.head.appendChild(v12Bell);

    if (window.location.pathname === '/settings') {
        var themePreview = document.createElement('script');
        themePreview.src = '/static/js/theme-live-v2.js?v=2026.09.21.16';
    ...
    if (window.location.pathname.startsWith('/barcodes/')) {
        ...
        targets.src = '/static/js/barcode-targets-v6.js?v=2026.09.21.16';
        targets.async = false;
