...
(function() {
    ...
    if (window.location.pathname.startsWith('/barcodes/')) {
        ...
        targets.src = '/static/js/barcode-targets-v6.js?v=2026.09.21.9';
        targets.async = false;
